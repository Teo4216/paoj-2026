            ...
            try {
                switch (option) {
                    ...
                    case "5":
                        ...
                        if (averages.isEmpty()) {
                            System.out.println("Nu există nicio nota inregistrată.");
                        } else {
                ...
                System.out.println("Eroare: Introdu un număr valid pentru varsta/notă.");
            } catch (IllegalArgumentException e) {
                System.out.println("Eroare: Materia introdusa nu exista.");
